...
Operand Translation::Add(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Add(input0, input1, output));
  return output;
}

Operand Translation::And(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::And(input0, input1, output));
  return output;
}

Operand Translation::Bisz(Operand input0, Operand output) {
  translation_.push_back(reil::Bisz(input0, output));
  return output;
}

Operand Translation::Bsh(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Bsh(input0, input1, output));
  return output;
}

Operand Translation::Div(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Div(input0, input1, output));
  return output;
}

Operand Translation::Sdiv(Operand input0, Operand input1, Operand output) {
...
void Translation::Jcc(Operand input0, Operand output) {
  translation_.push_back(reil::Jcc(input0, output));
}

void Translation::JccHint(Operand input0, Operand input1, Operand output) {
  if (flags_ & kPureReil) {
    translation_.push_back(reil::Jcc(input0, output));
  } else {
...
void Translation::Jump(Operand input0, Operand output) {
  JccHint(input0, kJump, output);
}

void Translation::Jump(Operand output) { JccHint(Imm8(1), kJump, output); }

void Translation::Call(Operand output) { JccHint(Imm8(1), kCall, output); }

void Translation::Return(Operand output) { JccHint(Imm8(1), kReturn, output); }

Operand Translation::Ldm(Operand input0, Operand output) {
  translation_.push_back(reil::Ldm(input0, output));
  return output;
}

Operand Translation::Mod(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Mod(input0, input1, output));
  return output;
}

Operand Translation::Mul(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Mul(input0, input1, output));
  return output;
}

Operand Translation::Smul(Operand input0, Operand input1, Operand output) {
  uint16_t size = Size(input0);
...
Operand Translation::Nop(Operand input0) {
  translation_.push_back(reil::Nop(input0));
  return input0;
}

Operand Translation::Not(Operand input0, Operand output) {
  translation_.push_back(
      reil::Xor(input0, Immediate::Mask(Size(input0)), output));
  return output;
}

Operand Translation::Or(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Or(input0, input1, output));
  return output;
}

Operand Translation::Stm(Operand input0, Operand output) {
  translation_.push_back(reil::Stm(input0, output));
  return output;
}

Operand Translation::Str(Operand input0, Operand output) {
  translation_.push_back(reil::Str(input0, output));
  return output;
}

Operand Translation::Sub(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Sub(input0, input1, output));
  return output;
}

void Translation::Undef(Operand output) {
  translation_.push_back(reil::Undef(output));
}

void Translation::Unkn() { translation_.push_back(reil::Unkn()); }

Operand Translation::Xor(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Xor(input0, input1, output));
  return output;
}

Operand Translation::Bisnz(Operand input0, Operand output) {
  translation_.push_back(reil::Bisnz(input0, output));
  return output;
}

Operand Translation::Equ(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Equ(input0, input1, output));
  return output;
}

Operand Translation::Lshl(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Lshl(input0, input1, output));
  return output;
}

Operand Translation::Lshr(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Lshr(input0, input1, output));
  return output;
}

Operand Translation::Ashr(Operand input0, Operand input1, Operand output) {
  translation_.push_back(reil::Ashr(input0, input1, output));
  return output;
}

Operand Translation::Sex(Operand input0, Operand output) {
  translation_.push_back(reil::Sex(input0, output));
  return output;
}

void Translation::Sys(Operand input0) {
  translation_.push_back(reil::Sys(input0));
}

Operand Translation::Ite(Operand input0, Operand input1, Operand input2,
                         Operand output) {
  if (flags_ & kPureReil) {
    abort();
  } else {
...
Operand Translation::Add(Operand input0, Operand input1) {
  return Add(input0, input1, Tmp(Size(input0) * 2));
}

Operand Translation::Mul(Operand input0, Operand input1) {
  return Mul(input0, input1, Tmp(Size(input0) * 2));
}

Operand Translation::Smul(Operand input0, Operand input1) {
  return Smul(input0, input1, Tmp(Size(input0) * 2));
}

Operand Translation::Sub(Operand input0, Operand input1) {
  return Sub(input0, input1, Tmp(Size(input0) * 2));
}

Operand Translation::And(Operand input0, Operand input1) {
  return And(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Div(Operand input0, Operand input1) {
  return Div(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Sdiv(Operand input0, Operand input1) {
  return Sdiv(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Mod(Operand input0, Operand input1) {
  return Mod(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Not(Operand input0) {
  return Not(input0, Tmp(Size(input0)));
}

Operand Translation::Or(Operand input0, Operand input1) {
  return Or(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Xor(Operand input0, Operand input1) {
  return Xor(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Lshl(Operand input0, Operand input1) {
  return Lshl(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Lshr(Operand input0, Operand input1) {
  return Lshr(input0, input1, Tmp(Size(input0)));
}

Operand Translation::Ashr(Operand input0, Operand input1) {
...
Operand Translation::Bisz(Operand input0) { return Bisz(input0, Tmp(8)); }

Operand Translation::Bisnz(Operand input0) { return Bisnz(input0, Tmp(8)); }

Operand Translation::Equ(Operand input0, Operand input1) {
  return Equ(input0, input1, Tmp(8));
}

std::tuple<Operand, Operand> Translation::SignedToUnsigned(Operand value) {
...
Operand Translation::UnsignedToSigned(Operand value, Operand negative) {
  uint16_t size = Size(value);

  auto positive = Bisz(negative, Tmp(size));
  auto tmp1 = And(value, Immediate::SignedMax(size), Tmp(size));
  auto tmp2 = Str(Add(Not(value), Imm(size, 1)), Tmp(size));
  auto negative_value = Str(Mul(negative, tmp2), Tmp(size));

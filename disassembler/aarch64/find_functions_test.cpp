...
00000000004000b0 <function4>:
  ...
  4000c4: d65f03c0  ret
*/
TEST(FindFunctions, SimdStpPrologue) {
  auto memory_image =
      MemoryImage::Load("disassembler/test_data/simd_stp_prologue.mem");
  ASSERT_NE(memory_image, nullptr);
